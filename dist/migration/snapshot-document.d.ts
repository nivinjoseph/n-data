 ...
 */
export declare function toSnapshotDocument<TState extends AggregateState, TDomainEvent extends DomainEvent<TState>>(aggregate: AggregateRoot<TState, TDomainEvent>): SnapshotDocumentOf<TState>;
/**
 ...
 */
export declare function snapshotDocumentToState<TState>(document: SnapshotDocumentOf<TState>): TState;
//# sourceMappingURL=snapshot-document.d.ts.map