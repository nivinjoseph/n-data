...
import { BuiltRepositoryQuery, RepositoryQueryBuilder } from "./repository-query.js";
...
export abstract class OrgEventStreamBaseRepository<T extends OrgAggregateRoot<TState, TDomainEvent>, TState extends OrgAggregateState, TDomainEvent extends OrgDomainEvent<TState>> extends BaseRepository implements Repository<T>
{
    ...
    public getByIds(ids: ReadonlyArray<string>): Promise<Array<T>>
    {
        ...
        return this._run(RepositoryQueryBuilder.build(this.table,
            RepositoryQueryBuilder.idPredicate("aggregate_id", trimmed), [],
     ...
     */
    private async _run(built: BuiltRepositoryQuery): Promise<Array<T>>
    {
